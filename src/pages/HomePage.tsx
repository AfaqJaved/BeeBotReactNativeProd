    ...
    <LayoutWrapper navigation={navigation}>
      <View
        ...
        <MenuItem
          ...
          // heightLand={50}
          heightLand={
            isTabletAndPortrait() ? 50 : isTabletAndLandScape() ? 30 : 50
          }
          heightPort={25}
          label={t('lessons')}
          onClick={() => {
        ...
        <MenuItem
          ...
          heightLand={
            isTabletAndPortrait() ? 45 : isTabletAndLandScape() ? 30 : 45
          }
        ...
        <MenuItem
          ...
          width={
            isTabletAndPortrait() ? 28.6 : isTabletAndLandScape() ? 28.6 : 44
          }
          heightLand={
            isTabletAndPortrait() ? 45 : isTabletAndLandScape() ? 30 : 45
          }
