...
import { View, Text, StyleSheet, Image, TouchableOpacity, ScrollView, ImageBackground, Alert, Dimensions, Linking } from "react-native";
import { isTablet, isTabletAndLandScape, isTabletAndPortrait, useResponsiveHeight, useResponsiveWidth } from "../utils/Utils";
    ...
    <LayoutWrapper navigation={navigation}>
      <View
        style={{
          ...
          rowGap: useResponsiveWidth(1.5),
          columnGap: useResponsiveWidth(2),
      ...
      >
        ...
        <MenuItem
          ...
          label={t("scratch")}
          onClick={() => {
            Linking.openURL(CONSTANTS.SCRATCH_URL).catch((err) => console.error("Couldn't load page", err));
          }}
        ></MenuItem>
